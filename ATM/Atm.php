...
//			echo $data['operation_type'] . "\r\n";
//			echo $data['amount'] . "\r\n";
//			echo $data['currency'] . "\r\n";
			$this->stdOut( $data['date'], $data['client_id'], $data['client_type'], $data['operation_type'], $data['amount'], $data['currency'] );
		}
	}
	 ...
	 */
	public function stdOut( $operation_date, $operation_client_id, $operation_client_type, $operation_type, $operation_amount, $operation_currency ) {
		...
		if ( $this->getOperationType() === 'cash_in' ) {
			...
			$cash_out_fee = Taxes::cashOutFee( $this->getOperationAmount(), $this->getOperationCurrency(), $this->getOperationClientType() );
